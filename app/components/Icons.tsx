// SVG icon components — paths based on Heroicons (MIT License, outline 24x24)
...
export function AdjustmentsIcon({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export function WindIcon({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M3 8h12.5a2.5 2.5 0 0 0 0-5H14M3 12h17.5a2.5 2.5 0 0 1 0 5H19M3 16h8.5a2.5 2.5 0 0 1 0 5H10" />
    </svg>
  )
}
...
export function DropletIcon({ className = 'w-6 h-6' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 3.75c-3.1 3.679-6 7.148-6 10.5a6 6 0 0 0 12 0c0-3.352-2.9-6.821-6-10.5Z" />
    </svg>
  )
}
